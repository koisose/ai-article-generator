      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center mb-8">
            <span className="block text-2xl mb-2">Decentralized Hackathon</span>
            <span className="block text-4xl font-bold">Dethon</span>
          </h1>
          <p className="text-center text-lg">
         Im trying to develop an app that hopefully can tackle issues where payment isn't paid by the hackathon project owner
        ...
        <div className="flex-grow bg-base-300 w-full mt-16 px-8 py-12">
          <h1 className="text-center mb-8">
            <span className="block text-2xl mb-2">How is this work?</span>
